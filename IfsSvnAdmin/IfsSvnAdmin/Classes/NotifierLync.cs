    ...
    internal class NotifierLync
    {
        ...
        internal NotifierLync()
        {
            try
            {
                ...
                _ModalitySettings.Add(AutomationModalitySettings.Subject, "IFS SVN Manager");
        ...
        internal void SendMessage(string inviteeEmail, string imText)
        {
            try
            {
                ...
                {
                    _ModalitySettings[AutomationModalitySettings.FirstInstantMessage] = "IFS SVN Manager! : " + imText;
                }
                else
                {
                    _ModalitySettings.Add(AutomationModalitySettings.FirstInstantMessage, "IFS SVN Manager! : " + imText);
                }
